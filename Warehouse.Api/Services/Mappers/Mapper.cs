    ...
    public class MapperProfile : Profile
    {
        public MapperProfile()
        {
            ...
            CreateMap<Item, ItemDTO>()
                ...
                .ForMember(dest => dest.BasePrice, opt => opt.MapFrom(src => src.Provisions.Sum(p => p.Qtty) != 0 ? src.Provisions.Select(p => p.BasePrice * p.Qtty).Average() / src.Provisions.Sum(p => p.Qtty) : 0));
